...
`ifndef ETH_TEST_TX_DF_SV
`define ETH_TEST_TX_DF_SV


class eth_test_tx_df extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_df)
  ...
  function void build_phase(uvm_phase phase);
    ...
    factory.set_type_override_by_type(
      ...
      wb_s_seq_tx_df::get_type()
  );

    factory.set_type_override_by_type(
      mii_tx_driver_base::get_type(),
      mii_tx_driver_df::get_type()
  );
