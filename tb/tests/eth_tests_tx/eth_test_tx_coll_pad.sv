...
`ifndef ETH_TEST_TX_COLL_PAD_SV
`define ETH_TEST_TX_COLL_PAD_SV


class eth_test_tx_coll_pad extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_coll_pad)
  ...
  function void build_phase(uvm_phase phase);
    ...
    factory.set_type_override_by_type(
      ...
      wb_s_seq_tx_collision_pad::get_type()
  );

    factory.set_type_override_by_type(
      mii_tx_driver_base::get_type(),
      mii_tx_driver_collision::get_type()
  );
  
    factory.set_type_override_by_type(
      eth_v_seq_tx::get_type(),
      eth_v_seq_tx_collision::get_type()
  );

    factory.set_type_override_by_type(
      mii_tx_seq_collision::get_type(),
      mii_tx_seq_collision_pad::get_type()
  );
