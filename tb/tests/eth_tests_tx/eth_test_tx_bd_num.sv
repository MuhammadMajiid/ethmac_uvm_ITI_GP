...
`ifndef ETH_TEST_TX_BD_NUM_SV
`define ETH_TEST_TX_BD_NUM_SV


class eth_test_tx_bd_num extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_bd_num)
