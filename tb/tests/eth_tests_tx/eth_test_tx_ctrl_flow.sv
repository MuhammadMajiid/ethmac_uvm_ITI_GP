`ifndef ETH_TEST_TX_CTRL_FLOW_SV
`define ETH_TEST_TX_CTRL_FLOW_SV

class eth_test_tx_ctrl_flow extends eth_test_tx_base;
    `uvm_component_utils(eth_test_tx_ctrl_flow)
