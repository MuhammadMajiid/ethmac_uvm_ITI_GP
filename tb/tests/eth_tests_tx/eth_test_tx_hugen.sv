...
`ifndef ETH_TEST_TX_HUGEN_SV
`define ETH_TEST_TX_HUGEN_SV


class eth_test_tx_hugen extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_hugen)
