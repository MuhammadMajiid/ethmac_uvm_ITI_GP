...
`ifndef ETH_TEST_TX_MINFL_SV
`define ETH_TEST_TX_MINFL_SV


class eth_test_tx_minfl extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_minfl)
