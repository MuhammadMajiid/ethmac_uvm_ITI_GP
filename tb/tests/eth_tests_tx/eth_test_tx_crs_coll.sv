...
`ifndef ETH_TEST_TX_CRS_COLL_SV
`define ETH_TEST_TX_CRS_COLL_SV


class eth_test_tx_crs_coll extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_crs_coll)
  ...
  function void build_phase(uvm_phase phase);
    ...
    factory.set_type_override_by_type(
      ...
      wb_s_seq_tx_crs_coll_cfg::get_type()
  );
