...
`ifndef ETH_TEST_TX_MODER_SV
`define ETH_TEST_TX_MODER_SV


class eth_test_tx_moder extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_moder)
