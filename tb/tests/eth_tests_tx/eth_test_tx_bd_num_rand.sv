...
`ifndef ETH_TEST_TX_BD_NUM_RAND_SV
`define ETH_TEST_TX_BD_NUM_RAND_SV


class eth_test_tx_bd_num_rand extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_bd_num_rand)
  ...
  function void build_phase(uvm_phase phase);
    ...
    factory.set_type_override_by_type(
      ...
      wb_s_seq_tx_bd_num_rand::get_type()
  );
