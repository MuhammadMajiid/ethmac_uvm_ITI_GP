...
`ifndef ETH_TEST_TX_COLL_PRE_SV
`define ETH_TEST_TX_COLL_PRE_SV


class eth_test_tx_coll_pre extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_coll_pre)
  ...
  function void build_phase(uvm_phase phase);
    ...
    factory.set_type_override_by_type(
      ...
      wb_s_seq_tx_collision_pre::get_type()
  );
    ...
    factory.set_type_override_by_type(
      ...
      mii_tx_seq_collision_pre::get_type()
  );
