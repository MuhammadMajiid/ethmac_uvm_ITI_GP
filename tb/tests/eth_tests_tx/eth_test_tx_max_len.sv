...
`ifndef ETH_TEST_TX_MAX_LEN_SV
`define ETH_TEST_TX_MAX_LEN_SV


class eth_test_tx_max_len extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_max_len)
