...
`ifndef ETH_TEST_TX_INTERRUPTS_SV
`define ETH_TEST_TX_INTERRUPTS_SV


class eth_test_tx_interrupts extends eth_test_tx_base;
  `uvm_component_utils(eth_test_tx_interrupts)
  ...
  function void build_phase(uvm_phase phase);
    ...
    factory.set_type_override_by_type(
      ...
      wb_s_seq_tx_interrupts::get_type()
  );
