...
//==============================================================================
`ifndef WB_S_TX_PAD_SV
`define WB_S_TX_PAD_SV
class wb_s_seq_tx_pad extends wb_s_basic_tx_seq;

    `uvm_object_utils(wb_s_seq_tx_pad)

    //---------------------------------------------------------
    function new(string name="wb_s_seq_tx_pad");
        super.new(name);
    endfunction
    ...
    // Configure registers
    //-----------------------------------------------------
    configure_tx_registers(.tx_bd_num(m_item.tx_bd_num),.fulld(1),.txen(1),.pad(0),.crcen(0),.maxfl(m_item.maxfl),.minfl(m_item.minfl));
