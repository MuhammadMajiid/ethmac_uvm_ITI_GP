class eth_v_seq_tx extends eth_v_seq_base;
 `uvm_object_utils(eth_v_seq_tx)
    ...
    wb_s_control_frame_tx_seq m_wb_s_control_frame_tx_seq;

    function new(string name ="eth_v_seq_tx");
        super.new(name);
        m_wb_s_control_frame_tx_seq = wb_s_control_frame_tx_seq::type_id::create("wb_s_control_frame_tx_seq");  
    ...
    virtual task body();
        ...
        m_wb_s_control_frame_tx_seq.start(m_wb_s_sqr);
